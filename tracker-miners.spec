...
Source0  : https://download.gnome.org/sources/tracker-miners/2.3/tracker-miners-2.3.0.tar.xz
...
%prep
%setup -q -n tracker-miners-2.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568077609
