...
Source0  : https://download.gnome.org/sources/tracker-miners/3.4/tracker-miners-3.4.2.tar.xz
...
%prep
%setup -q -n tracker-miners-3.4.2
cd %{_builddir}/tracker-miners-3.4.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670510737
