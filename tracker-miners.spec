...
Source0  : https://download.gnome.org/sources/tracker-miners/3.6/tracker-miners-3.6.2.tar.xz
...
%prep
%setup -q -n tracker-miners-3.6.2
cd %{_builddir}/tracker-miners-3.6.2
pushd ..
cp -a tracker-miners-3.6.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698772042
