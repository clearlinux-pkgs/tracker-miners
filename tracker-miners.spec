...
Source0  : https://download.gnome.org/sources/tracker-miners/2.1/tracker-miners-2.1.5.tar.xz
...
Requires: tracker-miners-config = %{version}-%{release}
...
%prep
%setup -q -n tracker-miners-2.1.5
...
export LANG=C
export SOURCE_DATE_EPOCH=1537979032
