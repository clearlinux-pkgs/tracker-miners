...
Source0  : https://download.gnome.org/sources/tracker-miners/2.0/tracker-miners-2.0.5.tar.xz
...
%prep
%setup -q -n tracker-miners-2.0.5
...
export LANG=C
export SOURCE_DATE_EPOCH=1530989353
