...
Source0  : https://download.gnome.org/sources/tracker-miners/3.7/tracker-miners-3.7.0.tar.xz
...
%prep
%setup -q -n tracker-miners-3.7.0
cd %{_builddir}/tracker-miners-3.7.0
pushd ..
cp -a tracker-miners-3.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710945113
