...
Version  : 3.4.1
Release  : 44
URL      : https://download.gnome.org/sources/tracker-miners/3.4/tracker-miners-3.4.1.tar.xz
Source0  : https://download.gnome.org/sources/tracker-miners/3.4/tracker-miners-3.4.1.tar.xz
...
%prep
%setup -q -n tracker-miners-3.4.1
cd %{_builddir}/tracker-miners-3.4.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666906725
