...
Version  : 3.7.1
Release  : 58
URL      : https://download.gnome.org/sources/tracker-miners/3.7/tracker-miners-3.7.1.tar.xz
Source0  : https://download.gnome.org/sources/tracker-miners/3.7/tracker-miners-3.7.1.tar.xz
...
%prep
%setup -q -n tracker-miners-3.7.1
cd %{_builddir}/tracker-miners-3.7.1
pushd ..
cp -a tracker-miners-3.7.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711663378
