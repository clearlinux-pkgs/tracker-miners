...
Source0  : https://download.gnome.org/sources/tracker-miners/2.1/tracker-miners-2.1.3.tar.xz
...
%prep
%setup -q -n tracker-miners-2.1.3
...
export LANG=C
export SOURCE_DATE_EPOCH=1535723613
