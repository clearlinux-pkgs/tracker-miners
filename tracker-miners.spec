...
Source0  : https://download.gnome.org/sources/tracker-miners/3.3/tracker-miners-3.3.1.tar.xz
...
%prep
%setup -q -n tracker-miners-3.3.1
cd %{_builddir}/tracker-miners-3.3.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654117090
...
cp %{_builddir}/tracker-miners-3.3.1/COPYING.GPL %{buildroot}/usr/share/package-licenses/tracker-miners/33fabce185708a9b17df7a9f37c7ed44eddc7e48
cp %{_builddir}/tracker-miners-3.3.1/COPYING.LGPL %{buildroot}/usr/share/package-licenses/tracker-miners/9a1929f4700d2407c70b507b3b2aaf6226a9543c
cp %{_builddir}/tracker-miners-3.3.1/src/libtracker-miner/COPYING.LIB %{buildroot}/usr/share/package-licenses/tracker-miners/9a1929f4700d2407c70b507b3b2aaf6226a9543c
cp %{_builddir}/tracker-miners-3.3.1/src/libtracker-miners-common/COPYING.LIB %{buildroot}/usr/share/package-licenses/tracker-miners/9a1929f4700d2407c70b507b3b2aaf6226a9543c
