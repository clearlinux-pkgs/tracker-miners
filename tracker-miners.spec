...
Version  : 2.2.1
Release  : 19
URL      : https://download.gnome.org/sources/tracker-miners/2.2/tracker-miners-2.2.1.tar.xz
Source0  : https://download.gnome.org/sources/tracker-miners/2.2/tracker-miners-2.2.1.tar.xz
...
%prep
%setup -q -n tracker-miners-2.2.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1555529882
...
cp COPYING.GPL %{buildroot}/usr/share/package-licenses/tracker-miners/COPYING.GPL
cp COPYING.LGPL %{buildroot}/usr/share/package-licenses/tracker-miners/COPYING.LGPL
cp src/libtracker-miners-common/COPYING.LIB %{buildroot}/usr/share/package-licenses/tracker-miners/src_libtracker-miners-common_COPYING.LIB
...
/usr/lib64/tracker-miners-2.0/libtracker-miners-common.so
...
/usr/share/package-licenses/tracker-miners/COPYING.GPL
/usr/share/package-licenses/tracker-miners/COPYING.LGPL
/usr/share/package-licenses/tracker-miners/src_libtracker-miners-common_COPYING.LIB
